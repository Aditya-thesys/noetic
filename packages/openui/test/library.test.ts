...
describe('createLibrary', () => {
  ...
  test('systemPrompt lists signatures with optionality and descriptions', () => {
    // The prompt is generated by @openuidev/lang-core (the language's source of
    // truth), so its exact wording is lang-core's, not this package's.
    ...
    expect(prompt).toContain('Each statement is on its own line');
  });
});
